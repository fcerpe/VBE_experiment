...
function questions = vbBlock_createQuestionList(cfg)
    %
    ...
    questions.questionsToAsk = cell(5, 2);
...
%     end
    ...
    questions.questionsToAsk{5, 1} = questions.startCondition;
    questions.questionsToAsk{5, 2} = true;
